    ...
    <div class="container mx-auto px-4">
      <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <h1 class="text-2xl font-bold text-gray-900 mb-4">Thanh toán thất bại</h1>
          <p class="text-gray-600 mb-6">{{ errorMessage || 'Đã có lỗi xảy ra trong quá trình thanh toán. Vui lòng thử lại.' }}</p>
          ...
          <div v-if="orderId" class="bg-gray-50 rounded-lg p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span class="text-red-600 ml-2 font-medium">Thanh toán thất bại</span>
              </div>
            </div>
          </div>
          ...
          <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <div class="flex items-start">
              ...
              <div class="text-left">
                <p class="text-sm font-medium text-yellow-800 mb-1">Lưu ý quan trọng</p>
                <p class="text-sm text-yellow-700">
                  Nếu bạn đã thanh toán thành công nhưng thấy thông báo này, vui lòng kiểm tra đơn hàng hoặc liên hệ hỗ trợ để được xử lý.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="mt-8 pt-6 border-t border-gray-200">
            ...
            <div class="flex justify-center space-x-6 text-sm">
              <a href="tel:1900000000" class="text-blue-600 hover:text-blue-800 flex items-center">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                Hotline: 1900 000 000
              </a>
              <a href="mailto:support@example.com" class="text-blue-600 hover:text-blue-800 flex items-center">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const retryPayment = async () => {
  ...
  try {
    ...
    const message = error.response?.data?.message || error.message || 'Không thể tạo lại URL thanh toán';
    showError(message);
  } finally {
