  ...
  <div class="min-h-screen bg-gray-50 py-12">
    <div class="container mx-auto px-4">
      <div class="max-w-2xl mx-auto">
        ...
        <!-- Success State -->
        <div v-else-if="paymentStatus === 'success'" class="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <h1 class="text-2xl font-bold text-gray-900 mb-4">Thanh toán thành công!</h1>
          <p class="text-gray-600 mb-6">Cảm ơn bạn đã đặt hàng. Đơn hàng của bạn đã được xác nhận và sẽ được xử lý sớm nhất.</p>
          ...
          <div class="bg-gray-50 rounded-lg p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span class="text-green-600 ml-2 font-medium">Đã thanh toán</span>
              </div>
            </div>
          </div>
        ...
        <div v-else class="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <p class="text-gray-600 mb-6">{{ errorMessage || 'Không thể xác thực trạng thái thanh toán. Vui lòng liên hệ hỗ trợ nếu bạn đã thanh toán.' }}</p>
...
onMounted(async () => {
  try {
    ...
    if (status === 'success') {
      ...
      errorMessage.value = error ? decodeURIComponent(error) : 'Thanh toán thất bại';
    ...
    paymentStatus.value = 'error';
    errorMessage.value = error.response?.data?.message || error.message || 'Không thể xác thực thanh toán';
    showError(errorMessage.value);
  } finally {
    loading.value = false;
  }
