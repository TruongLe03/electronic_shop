      ...
      <div v-if="loading" class="flex justify-center items-center min-h-screen">
        <div class="flex flex-col items-center space-y-4">
          <div class="relative">
            ...
            ></div>
            <div
              class="animate-spin rounded-full h-16 w-16 border-4 border-indigo-600 border-t-transparent absolute top-0"
            ></div>
          </div>
      ...
      <div v-else class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div class="space-y-4">
            <!-- Main Image -->
            <div
              class="group relative aspect-square bg-white rounded-2xl shadow-lg overflow-hidden ring-1 ring-gray-200"
            >
              <img
          ...
          <div class="space-y-6">
            <!-- Header Info -->
            <div
              class="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg ring-1 ring-gray-200"
            >
            ...
            <!-- Price Section -->
            <div
              class="bg-gradient-to-r from-red-50 to-orange-50 rounded-2xl p-6 shadow-lg ring-1 ring-red-200"
            >
              ...
              <div
                ...
                class="mt-4 flex items-center text-sm text-gray-700"
              >
                <svg
                ...
                <span class="font-medium"
                  >Bảo hành: {{ product.warranty }}</span
                >
              </div>
            </div>
            ...
            <!-- Purchase Options -->
            <div
              class="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg ring-1 ring-gray-200 space-y-6"
            >
              <!-- Quantity Selector -->
              <div>
                ...
                <div class="flex items-center space-x-4">
                  <div class="flex items-center bg-gray-100 rounded-lg">
                    ...
                    <div
                      class="w-16 h-12 flex items-center justify-center bg-white border-x text-lg font-bold"
                    >
                      {{ quantity }}
                    </div>
                    <button
                  ...
                  <div class="flex items-center justify-center space-x-2">
                    ...
                    >
                      <path
                        ...
                        stroke-linejoin="round"
                        stroke-width="2"
                        d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13h.01m-.01 0l.01.01c1.36 0 2.5 1.14 2.5 2.5s-1.14 2.5-2.5 2.5-2.5-1.14-2.5-2.5 1.14-2.5 2.5-2.5z"
                      />
                    </svg>
                    <span>{{
        ...
        <div class="mt-16">
          <div
            class="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg ring-1 ring-gray-200 overflow-hidden"
          >
            <!-- Tab Headers -->
              ...
              <nav class="flex space-x-8 px-6">
                ...
                >
                  <span class="flex items-center space-x-2">
                    ...
                    <svg
                      v-else-if="tab.id === 'specifications'"
                      class="w-4 h-4"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
            ...
            <div class="p-8">
              ...
              <div v-if="activeTab === 'description'" class="space-y-6">
                ...
                <div class="prose max-w-none">
                  ...
                  <div
                    v-if="product.description_detail"
                    class="mt-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-indigo-200"
                  >
                    <h4 class="text-xl font-semibold mb-4 text-indigo-900">
                      Mô tả chi tiết
                    </h4>
                    <div
              ...
              <div v-if="activeTab === 'specifications'" class="space-y-6">
                ...
                >
                  <div class="divide-y divide-gray-200">
                    ...
                    >
                      <div
                        class="px-6 py-4 grid grid-cols-1 md:grid-cols-3 gap-4"
                      >
                        <div
                          class="font-semibold text-gray-900 flex items-center"
                        >
                          <div
                            class="w-2 h-2 bg-indigo-500 rounded-full mr-3"
                          ></div>
                          {{ spec.label }}
                        </div>
...
import Comments from "@components/client/Comments.vue";
...
const tabs = [
  ...
  { id: "reviews", name: "Bình luận & Đánh giá" },
];
