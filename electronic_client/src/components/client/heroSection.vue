...
const heroSlides = [
  {
    ...
    description: 'Bộ sưu tập Arduino, IoT và thiết bị điện tử hàng đầu với giá tốt nhất thị trường',
    buttonText: 'Mua Ngay',
    buttonLink: '/products',
    image: 'https://images.unsplash.com/photo-1518717758536-85ae29035b6d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600',
  ...
  },
  {
    ...
    description: 'Chương trình khuyến mãi lớn nhất trong năm cho tất cả sản phẩm Arduino và IoT',
    buttonText: 'Xem Ngay',
    buttonLink: '/deals',
    image: 'https://images.unsplash.com/photo-1581092795442-57a7bd3bc517?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600',
  ...
  },
  {
    ...
    description: 'Bộ kit hoàn chỉnh với hướng dẫn chi tiết, phù hợp cho học sinh và sinh viên',
    buttonText: 'Khám Phá',
    buttonLink: '/products/arduino-kit',
    image: 'https://images.unsplash.com/photo-1581092916274-b24875626894?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=600',
          ...
          <div class="container mx-auto px-4">
            <div class="max-w-2xl text-white">
              ...
              <div class="flex flex-col sm:flex-row gap-4">
                ...
                <button class="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-gray-900 transition-all duration-300">
    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="flex items-center p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
          ...
          <div>
            <h3 class="font-semibold text-gray-900 mb-1">Miễn Phí Vận Chuyển</h3>
